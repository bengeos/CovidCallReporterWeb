...
@Component({
    selector: 'app-assign-rapid-response',
    templateUrl: './assign-rapid-response.component.html',
    styleUrls: ['./assign-rapid-response.component.scss']
})
export class AssignRapidResponseComponent implements OnInit {
    public selectedCallReport = new CallReport();
    public newAssignCallReport = new AssignedCallReport();
    public teams: Team[] = [];
    public loading = false;

    constructor(private teamsService: TeamsService, public dialogRef: MatDialogRef<AssignRapidResponseComponent>,
